...
export default {
  ...
  created() {
    ...
    descEl.setAttribute('content', `Ver Todos Los Animes ${this.typeTitle} Online HD en español Latino con los mejores servidores y la cantidad minima de anuncios`)
  },
  updated() {
    document.title = `${process.env.VUE_APP_APP_TITLE} - Ver Animes ${this.typeTitle} Online en HD Latino`
    const descEl = document.querySelector('head meta[name="description"]');
