...
export default {
  ...
  created() {
    ...
    descEl.setAttribute('content', `Ver Todas Las Peliculas ${this.typeTitle} Online HD en español Latino con los mejores servidores y la mejor calidad de streaming`)
  },
  updated() {
    document.title = `${process.env.VUE_APP_APP_TITLE} - Ver Peliculas ${this.typeTitle} Online en HD Latino`
    const descEl = document.querySelector('head meta[name="description"]');
