<template>
  <div class="mt-3">
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          <div class="ratio ratio-16x9">
            <iframe
              :title="['Reproductor de Video ' + (active + 1)]"
              :src="opReproductores[active]"
              allowfullscreen
            >
    ...
    <div
      v-if="navegacion"
      class="d-grid d-sm-block mx-auto col-sm-12 col-8 text-center mt-3"
    >
      <router-link
...
export default {
  ...
  computed: {
    ...
    navegacion() {
      return this.reproductores.navegacion ? this.reproductores.navegacion : [];
    },
  },
  watch: {
    "$route.hash"() {
